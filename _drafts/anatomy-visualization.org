...
SELECT
  ...
  END || '/' || plate_numbers.rank || '/' || structure_id || '/' || rank() OVER (ORDER BY answers.id) || ': ' || input || '.' || CASE replace(split_part(structures.name, ' ', 1), '.', '') 
WHEN 'a' THEN 'artery' WHEN 'v' THEN 'vein' WHEN 'lig' THEN 'ligament' WHEN 'ligamentum' THEN 'ligament' WHEN 'm' THEN 'muscle' WHEN 'os' THEN 'bone' WHEN 'n' THEN 'nerve' ELSE 'other' END,
  CASE split_part(structures.name, ' ', 1)
    WHEN 'a.' THEN 'FF0000'
    WHEN 'v.' THEN '0000FF'
    WHEN 'lig.' THEN 'FFE8D5'
    WHEN 'ligamentum' THEN 'FFE8D5'
    WHEN 'm.' THEN '5F021F'
    WHEN 'os' THEN 'FFFFFF'
    WHEN 'n.' THEN 'FFFF00'
    ELSE '737373'
...
#+NAME: answers-path
#+RESULTS:
[[file:/tmp/answers_2b693e58b89c1e542383578949683dec.log]]
...
#+RESULTS:
: 1442729360|1|A|Knee joint/1/617/1: meniscus medialis.Other|737373
: 1442729371|1|A|Knee joint/1/616/2: lig. cruciatum posterior.Ligament|FFE8D5
: 1442729377|1|A|Knee joint/1/618/3: meniscus lateralis.Other|737373
