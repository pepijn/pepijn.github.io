...
SELECT
  ...
  CASE
    ...
    ELSE 'M'
  END,
  category_id || '/' || plate_id || '/' || structure_id || '/' || rank() OVER (ORDER BY answers.id) || ': ' || input,
  CASE
...
JOIN plates ON plates.id = plate_id
...
#+NAME: answers-path
#+RESULTS:
[[file:/tmp/answers_48b62091524d98bc7906fd2dc2efe25e.log]]
...
#+RESULTS:
: 1442729360|1|A|7/56/617/1: meniscus medialis|00FF00
: 1442729371|1|A|7/56/616/2: lig. cruciatum posterior|00FF00
: 1442729377|1|A|7/56/618/3: meniscus lateralis|00FF00
