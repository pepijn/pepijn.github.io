...
We define the =exam-date= so we can use it in the code blocks below:
...
SELECT
  ...
  CASE round(similarity(input, structures.name)::numeric, 1)
    WHEN 1 THEN '00FF00'
...
#+NAME: answers-path
#+RESULTS:
[[file:/tmp/answers_d659c902fd1642c7ed8ec3df3ca925e7.log]]
